...
namespace E_Commerce.Migrations
{
    ...
    [Migration("20220308121609_dbchangenews")]
    partial class dbchangenews
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_Commerce.Models.TblCart", b =>
                {
                    b.Property<int>("cartprouctid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int?>("Productidproduct_id")
                        .HasColumnType("int");

                    b.Property<string>("userid")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("cartprouctid");

                    b.HasIndex("Productidproduct_id");
            ...
            modelBuilder.Entity("E_Commerce.Models.TblCart", b =>
                {
                    b.HasOne("E_Commerce.Models.Product", "Productid")
                        .WithMany()
                        .HasForeignKey("Productidproduct_id");
