...
namespace E_Commerce.Migrations
{
    ...
    [Migration("20220314124754_datatablesw")]
    partial class datatablesw
    {
            ...
            modelBuilder.Entity("E_Commerce.Models.TBLorder", b =>
                {
                    b.HasOne("E_Commerce.Models.tblAddress", "Address")
                        .WithOne("ord")
                        .HasForeignKey("E_Commerce.Models.TBLorder", "ad_id");

                    b.HasOne("E_Commerce.Models.Product", "prd")
                        .WithOne("ord")
                        .HasForeignKey("E_Commerce.Models.TBLorder", "product_id");
